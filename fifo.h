#ifndef _POSIXSRV_FIFO_H
#define _POSIXSRV_FIFO_H
...
static inline unsigned fifo_read(fifo_t *f, char *buffer, unsigned bytes)
{
	unsigned count = 0;
...
static inline unsigned fifo_write(fifo_t *f, char *buffer, unsigned bytes)
{
	unsigned count = 0;
